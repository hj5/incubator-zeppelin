...
#
#export ZEPPELIN_PORT=18000
#export ZEPPELIN_INTP_JAVA_OPTS=-Dfile.encoding=UTF-8 -Xmx1024m -XX:MaxPermSize=512m -Dzeppelin.log.file=/Users/hj/Documents/zeppelin/zeppelin_lebron-hj/incubator-zeppelin/logs/zeppelin-hj-hj.local.log
#export ZEPPELIN_JAVA_OPTS="-Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=10444"

export JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk1.7.0_79.jdk/Contents/Home
# export JAVA_HOME=/Users/hj/Documents/openjdk/openjdk7-fastdebug
