...
#DEBUG_PORT=$(($PORT+1))
#echo "DEBUG_PORT========interpreter=========:${DEBUG_PORT}"
#DEBUG_JAVA_OPTS=" -Xms512m -Xmx512m -Dscala.usejavacp=true -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=${DEBUG_PORT}"
