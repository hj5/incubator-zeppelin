 ...
 * </ul>
 */
public class ScalaIgniteInterpreter extends Interpreter {
  ...
  static {
    Interpreter.register(
            "ignite",
            "ignite",
            ScalaIgniteInterpreter.class.getName(),
  ...
  private Logger logger = LoggerFactory.getLogger(ScalaIgniteInterpreter.class);
  private Ignite ignite;
  private ByteArrayOutputStream out;
  private IMain imain;
  private Throwable initEx;

  public ScalaIgniteInterpreter(Properties property) {
    super(property);
  }
    ...
    for (String s : linesToRun) {
      try {
        ...
        return new InterpreterResult(Code.ERROR, 
            InterpreterUtils.getMostRelevantMessage(new Exception(e)));
      }
  ...
  public Scheduler getScheduler() {
    return SchedulerFactory.singleton().createOrGetFIFOScheduler(
            ScalaIgniteInterpreter.class.getName() + this.hashCode());
  }
}
